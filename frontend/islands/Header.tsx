    ...
    <nav class={tw`bg-gray-800`}>
      ...
      <div class={tw`md:hidden`} id="mobile-menu">
        <div class={tw`px-2 pt-2 pb-3 space-y-1 sm:px-3`}>
          <a
            href="#"
            class={tw`bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium`}
            aria-current="page"
          >
            Organizations
          </a>
        ...
        <div class={tw`pt-4 pb-3 border-t border-gray-700`}>
          <div class={tw`flex items-center px-5`}>
            ...
            <div class={tw`ml-3`}>
              <div class={tw`text-base font-medium leading-none text-white`}>
                Tom Cook
              </div>
              <div class={tw`text-sm font-medium leading-none text-gray-400`}>
                tom@example.com
              </div>
            </div>
            <button
          ...
          <div class={tw`mt-3 px-2 space-y-1`}></div>
        </div>
      </div>
    </nav>
  );
